...
export default function AnimatedButton({ children }: { children: React.ReactNode }) {
  return (
    <button className="bg-green-900 no-underline group cursor-pointer relative shadow-2xl shadow-zinc-900 rounded-full p-px text-sm font-semibold leading-6 text-white inline-block">
